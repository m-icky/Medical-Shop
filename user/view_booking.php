			...
			<table class="table table-bordered table-hover">
				<!-- <thead class="thead-dark"> -->
					<tr>			
						...
						<th class="p-3 mb-2 bg-success text-light">Price</th>
						<th class="p-3 mb-2 bg-info text-light">Payment</th>
					...
					<?php
                        ...
                        $id=$_SESSION['loginid'];
                        $sql = "SELECT * FROM add_med, booking_view WHERE add_med.id = booking_view.product_id AND booking_view.user_id = '$id' AND booking_view.cart_status = 'Added To Cart'";
