        ...
        <div class="row align-items-stretch section-overlap">
          <div class="col-md-4">
            <div class="banner-wrap bg-warning h-100">
              <a href="view_med.php" class="h-100">
                <h5>View <br> Medicine</h5>
                <p>
                  Amet sit amet dolor
          ...
          <div class="col-md-4">
            <div class="banner-wrap h-100 ">
              <a href="add_feed.php" class="h-100">
                <h5>Add <br> Feedback</h5>
                <p>
                  Amet sit amet dolor
                  <strong>Lorem, ipsum dolor sit amet consectetur adipisicing.</strong>
                </p>
          ...
          <div class="col-md-4">
            <div class="banner-wrap h-100  bg-info">
              <a href="view_booking.php" class="h-100">
                <h5>View <br> Booking</h5>
                <p>
                  Amet sit amet dolor
                  <strong>Lorem, ipsum dolor sit amet consectetur adipisicing.</strong>
                </p>
          ...
          <!-- <div class="col-md-6 ">
            <div class="banner-wrap bg-danger h-100">
              <a href="add_med.php" class="h-100">
                <h5>Add <br> Medicine</h5>
                <p>
                  Amet sit amet dolor
                  <strong>Lorem, ipsum dolor sit amet consectetur adipisicing.</strong>
                </p>
          ...
          <!-- <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <div class="banner-wrap bg-warning h-100">
              <a href="remove_med.php" class="h-100">
                <h5>Remove <br> Medicine</h5>
                <p>
                  Amet sit amet dolor
                  <strong>Lorem, ipsum dolor sit amet consectetur adipisicing.</strong>
                </p>
