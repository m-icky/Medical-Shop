...
<body>
  ...
  <div class="site-wrap">
        ...
        <div class="d-flex align-items-center justify-content-between">
          ...
          <div class="main-nav d-none d-lg-block">
            <nav class="site-navigation text-right text-md-center" role="navigation">
              ...
              <li><a href="user_index.php">Back</a></li>
    ...
    <center><h1 class="p-2 mb-0 bg-warning text-light"><strong>Medicine Details</strong></h1><br></center>
    <section class="rooms-area section-padding-0-100">
        ...
        <div class="col-sm-6 col-lg-4 text-center item mb-4">
          ...
          <td><a type="submit"  class="btn btn-info py-2 px-3"  href="cart_act.php?id=<?php echo $data['id']; ?>">Add To Cart</a> </td>
          <td><a type="submit"  class="btn py-2 px-3 bg-warning text-light"  href="cart_act.php?id=<?php echo $data['id']; ?>">Buy Now</a> </td>
