  ...
  <div class="site-wrap">
        ...
        <div class="row">
          <div class="col-lg-7 mx-auto order-lg-2 align-self-center">
            <div class="site-block-cover-content text-center">
              ...
              <h2 class="sub-title">Home / Feedback</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-5 text-black">Add Feedback</h2>
          </div>
          <div class="col-md-12">
            <form action="add_feed_act.php" method="post">
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="feedback" class="text-black">Feedback <span class="text-danger">*</span></label>
