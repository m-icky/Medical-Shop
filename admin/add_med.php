        ...
        <div class="row">
          <div class="col-lg-7 mx-auto order-lg-2 align-self-center">
            <div class="site-block-cover-content text-center">
              ...
              <h2  class="sub-title">Home/Add Medicine</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <center>
            <h1 class="h3 mb-5 text-black text-uppercase mb-2" >Add Medicine</h1>
            </center>
          </div>
          <div class="col-md-12">
            <form action="add_med_act.php" method="post">
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="img" class="text-black">Medicine Image <span class="text-danger">*</span></label>
