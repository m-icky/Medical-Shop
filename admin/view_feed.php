...
<body>
  ...
  <div class="site-wrap">
        ...
        <div class="row">
          <div class="col-lg-7 mx-auto order-lg-2 align-self-center">
            <div class="site-block-cover-content text-center">
              ...
              <h2  class="sub-title">Home/View Feedback</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container add-emp">		
			<center><h1 class="p-2 mb-0 bg-info text-dark"><strong>Feedback Details</strong></h1><br></center>
			<table class="table table-bordered table-hover">
				<!-- <thead class="thead-dark"> -->
					<tr>			
						<th class="p-3 mb-2 bg-warning text-light">First Name </th>
						<th class="p-3 mb-2 bg-success text-light">Last Name</th>
